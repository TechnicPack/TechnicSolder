...
| Variable | Default | Description |
|----------|---------|-------------|
| `SOLDER_REPO_LOCATION` | `/var/www/mods.solder.test/` | Path or URL to the mod repository. Must include trailing slash. |
| `SOLDER_MIRROR_URL` | `http://mods.solder.test/` | Public URL the launcher uses to download mod files. Must include trailing slash. |
