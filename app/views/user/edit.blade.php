            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <label for="tag-create" class="checkbox-inline"><input type="checkbox" name="tag-create" id="tag-create" value="1"{{ $checked = ($user->permission->tags_create ? " checked" : "") }}> Create Tags</label>
                            <label for="tag-manage" class="checkbox-inline"><input type="checkbox" name="tag-manage" id="tag-manage" value="1"{{ $checked = ($user->permission->tags_manage ? " checked" : "") }}> Manage Tags</label>
                            <label for="tag-delete" class="checkbox-inline"><input type="checkbox" name="tag-delete" id="tag-delete" value="1"{{ $checked = ($user->permission->tags_delete ? " checked" : "") }}> Delete Tags</label>
                        </div>
                    </div>
                <div class="form-group">
