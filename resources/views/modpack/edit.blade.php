      ...
      <form method="POST" action="{{ URL::current() }}" accept-charset="UTF-8" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <p>Edit your modpack settings here. You are required to delete and re-import your pack on the Technic
              Platform when changing the Modpack slug</p>
            <hr>
            ...
            @if ($modpack->private || $modpack->private_builds())
              ...
              @else
                @foreach ($allClients as $client)
                  <div style="display: inline-block; padding-right: 10px;"><input type="checkbox" name="clients[]"
          ...
          <div class="col-md-6">
            ...
            <p>Modpack art (logo, icon and background images) are handled entirely by the <a
                href="https://www.technicpack.net/" target="_blank" rel="noopener">Technic Platform</a>.</p>
            <p>To change your modpack art you should go to your modpack settings in Platform and choose the "Resources"
              section.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            ...
            <a href="{{"/modpack/delete/".$modpack->id}}" class="btn btn-danger">Delete Modpack</a>
