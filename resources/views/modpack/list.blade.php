    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800">
        <div class="px-5 py-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-800">
            ...
            <a href="{{ url('modpack/create') }}"
               class="bg-green-600 hover:bg-green-700 text-white font-medium py-1.5 px-3 rounded-lg text-xs transition-colors">
                Create Modpack
            </a>
        </div>
        <div class="p-5">
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-gray-800/50 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                ...
                                @include('partial.data-table.sort-header', ['key' => 'recommended', 'label' => 'Rec'])
                                @include('partial.data-table.sort-header', ['key' => 'latest', 'label' => 'Latest'])
                                @include('partial.data-table.sort-header', ['key' => 'hidden', 'label' => 'Hidden'])
                                @include('partial.data-table.sort-header', ['key' => 'private', 'label' => 'Private'])
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                            <template x-for="row in paged" :key="row.id">
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                    ...
                                    <td class="px-5 py-3 text-gray-600 dark:text-gray-400" x-text="row.recommended"></td>
                                    <td class="px-5 py-3 text-gray-600 dark:text-gray-400" x-text="row.latest"></td>
                                    <td class="px-5 py-3">
