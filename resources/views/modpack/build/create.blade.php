    ...
    <div class="panel-body">
      ...
      <form method="post" action="{{URL::Current()}}">
        ...
        <div class="row">
          <div class="col-md-6">
            <h4>Create Build</h4>
            <p>All new builds by default will not be available in the API. They need to be published before they will
              show up.</p>
            <hr>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input disabled type="text" class="form-control" name="memory" id="memory" aria-label="mb"
        ...
        <a href="{{'modpack/view/'.$modpack->id}}" class="btn btn-primary">Go Back</a>
      </form>
    </div>
  </div>
@endsection
