      ...
      <form method="post" action="{{URL::Current()}}">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="alert alert-warning">If changes are made, users will need to re-install the modpack if they have
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="minecraft">
                @foreach ($minecraft as $version)
                  <option
                    value="{{ $version['version'] }}" {{ ($build->minecraft == $version['version'] ? ' selected' : '') }}>{{ $version['version'] }}</option>
                @endforeach
              </select>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p>These are requirements that are passed onto the launcher to prevent players from playing your pack
              without the required minumum settings</p>
            <hr>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="memory" id="memory" aria-label="mb"
        ...
        <a href="{{'modpack/build/'.$build->id.'?action=delete'}}" class="btn btn-danger">Delete Build</a>
        <a href="{{'modpack/build/'.$build->id}}" class="btn btn-primary">Go Back</a>
      </form>
    </div>
  </div>
@endsection
