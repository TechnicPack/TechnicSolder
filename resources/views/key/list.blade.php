                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 dark:bg-gray-800/50 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                            <tr>
                                ...
                                @include('partial.data-table.sort-header', ['key' => 'api_key', 'label' => 'API Key'])
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                            <template x-for="row in paged" :key="row.id">
                                <tr>
                                    ...
                                    <td class="px-5 py-3 text-gray-900 dark:text-gray-100 font-mono text-xs" x-text="row.api_key"></td>
                                    <td class="px-5 py-3">
