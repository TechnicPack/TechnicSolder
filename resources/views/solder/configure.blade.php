  ...
  <div class="tab-content">
    <div class="tab-pane fade in active" id="main">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="mirror_url" id="mirror_url"
                   value="{{ config('solder.mirror_url') }}" disabled>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="repo_location" id="repo_location"
                   value="{{ config('solder.repo_location') }}" disabled>
            ...
            <p class="alert alert-warning">The Repo Location is the prime suspect when MD5 hashing fails. Most cases are
              caused by improper file permissions when using an absolute file location</p>
          </div>

          <div class="form-group">
            <label for="md5_connect_timeout">MD5 Connect Timeout</label>
            <input type="text" class="form-control" name="md5_connect_timeout" id="md5_connect_timeout"
                   value="{{ config('solder.md5_connect_timeout') }}" disabled>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="md5_file_timeout" id="md5_file_timeout"
                   value="{{ config('solder.md5_file_timeout') }}" disabled>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <p>Solder now caches a list of minecraft versions and their MD5 checksums. First attempt is from the Technic
            Platform. If that fails, an internal library processes
            the list of versions from Mojang and calculates their MD5 checksums. The result from either is then cached.
            You can manually update the cache below.</p>
          <hr>
          ...
          @else
            <p id='minecraft-ajax' class="alert alert-warning">Minecraft versions are not cached. This may cause
              unexpectedly long page loads</p>
