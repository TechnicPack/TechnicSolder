    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <label>Current Version:
                        <span class="label label-default">{{ $currentVersion }}</span>
                    </label><br>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    @if (Cache::get('update'))
                        <p id='solder-update-ajax' class="alert alert-danger">Solder is out of date. Please refer to the
                            wiki on how to update.</p>
                    @else
                        <p id='solder-update-ajax' class="alert alert-success">Solder is up to date</p>
                    @endif
                    <a href="https://docs.solder.io/docs/updating-solder" target="blank_">
                        <button id='solder-wiki' class="btn btn-default">Updating Solder <i class="fa fa-question"></i>
                        </button>
                    </a>
                    <button id='solder-update' type="submit" class="btn btn-default">Check for update</button>
                    <span id="solder-checking" style="margin-left:10px;" class="hidden">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        @else
                            @foreach ($changelog as $change)
                                <a href="{{ $change['html_url'] }}" target="blank_" class="list-group-item">
                                    ...
                                    >{{ date_format(date_create($change['commit']['author']['date']), 'M, d Y - g:i a') }}</span>
                    ...
                    <div class="text-right">
                        <a href="https://github.com/TechnicPack/TechnicSolder/commits/master">View All Activity
