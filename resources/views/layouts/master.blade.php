...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav side-menu" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-folder fa-fw"></i> Modpacks
                ...
                <ul class="nav nav-second-level">
                    ...
                    @foreach ($allModpacks as $modpack)
                        @if ($modpack->icon)
                            <li>
                                <a href="{{ URL::to('modpack/view/'.$modpack->id) }}"><img src="{{ URL::asset('resources/' . $modpack->slug . '/icon.png') }}"
                                                                                           style="width: 16px; height: 16px;"
                                    > {{ $modpack->name }}{{ $modpack->hidden ? " (Hidden)" : "" }}</a></li>
                        @else
                            <li>
                                <a href="{{ URL::to('modpack/view/'.$modpack->id) }}"><img src="{{ URL::asset('resources/default/icon.png') }}"
                                                                                           style="width: 16px; height: 16px;"
                                    > {{ $modpack->name }}{{ $modpack->hidden ? " (Hidden)" : "" }}</a></li>
                        @endif
                    @endforeach
            ...
            <li>
                <a href="#"><i class="fa fa-book fa-fw"></i> Mod Library
                    <span class="fa arrow"></span>
                </a></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="#"><i class="fa fa-wrench fa-fw"></i> Configure Solder
                    <span class="fa arrow"></span>
                </a>
                <ul class="nav nav-second-level">
                    <li>
