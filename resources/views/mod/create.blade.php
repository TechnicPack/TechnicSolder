    ...
    <div class="panel-body">
      ...
      <form method="post" action="{{ URL::to('mod/create') }}">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <p>Because Solder doesn't do any file handling yet you will need to manually manage your set of mods in your
              repository. The mod repository structure is very strict and must match your Solder data exact. An example
              of your mod directory structure will be listed below:</p>
